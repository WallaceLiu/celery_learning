import unittest
import responses
from celery_chains.app.app import *
from celery_chains.app.tasks import *
...
class Tests(TestCase):
    ...
    def test_chain(self):
        responses.add(responses.GET,
                      'https://api.coindesk.com/v1/bpi/historical/close.json?start=2018-05-01&end=2018-05-08',
                      ...
                      status=200)
        task = chain(
            fetch_bitcoin_price_index.s(start_date='2018-05-01', end_date='2018-05-08'),
            calculate_moving_average.s(window=2)).apply()
