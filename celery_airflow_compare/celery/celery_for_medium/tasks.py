...
@json_to_sql_Celery_app.task(bind=True, name='json_to_sql.extract_raw_file', default_retry_delay=5,
...
@json_to_sql_Celery_app.task(bind=True, name='json_to_sql.process_raw_data', default_retry_delay=5,
                             retry_kwargs={'max_retries': 2})
...
@json_to_sql_Celery_app.task(bind=True, name='json_to_sql.send_to_mysql', default_retry_delay=5,
                             retry_kwargs={'max_retries': 2})
